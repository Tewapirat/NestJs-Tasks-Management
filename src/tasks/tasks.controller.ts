...
import { CurrentUserId } from './../users/decorators/current-user-id.decorators';
...
export class TasksController {
    ...
    // 2) addLables - mixing existing labels with new ones
    ...
    private checkTaskOwnership(task: Task, userId: string):
        ...
        if (task.userId !== userId) {
            throw new ForbiddenException('You can only access your owner tasks')
        }
    }
}
